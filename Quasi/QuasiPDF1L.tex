...
\tikzexternalize[shell escape=-enable-write18,prefix=./QuasiPDF1L/,system call={lualatex \tikzexternalcheckshellescape -halt-on-error -interaction=batchmode -jobname "\image" "\texsource"},up to date check=diff]
...
\begin{align}
	  & 4ig_s^2C_F\delta(1-x)\int\mm{l}\int_0^\infty\dd\lambda_1\dd\lambda_2\frac{1}{\pqty{l^2+i\epsilon}^3} \\
	= & ig_s^2C_F\delta(1-x)(2\pi)^2\int\mmd[6]{l_{D+2}}\frac{1}{\pqty{l^2+i\epsilon}^3}
\end{align}
...
We can also parametrize this as
\begin{align}
	& -4ig_s^2C_F\delta(1-x)\int\mm{l}\int_0^\infty\dd\lambda_1\dd\lambda_2\frac{1}{\bqty{l^2+2(\lambda_1+\lambda_2) n\cdot l+(\lambda_1-\lambda_2)i\epsilon}^3} 
\end{align}
