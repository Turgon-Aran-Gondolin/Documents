...
Expand to $v^2$ order, we have an extra vertex $\frac{\vb{p_1}^2+\vb{p_2}^2-2\vb{p_1\cdot p_2}-2i(\vb{p_1\times p_2})\cdot \bm{\sigma}}{8m^2}$ which is exactly those terms with denorminator $1/8m^2$ in BBL. 

We can write down the effective electron-photon vertex up to $\mathcal{O}(v^2)$
\begin{align*}
...
\begin{align*}
  ...
  &=e^4\bar u_N(P_N)u_N(P_N)\psi^{\dagger}(p_2)\int[\dd k]\frac{1}{\vb{k}^2(\vb{k}-\vb{q})^2(-k^0+i\epsilon)(p_1^0+k^0-m-\frac{\vb{(p_1+k)}^2}{2m}+i\epsilon)}\psi(p_1)\\
  &=-ie^4\bar u_N(P_N)u_N(P_N)\psi^{\dagger}(p_2)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{1}{\vb{k}^2(\vb{k}-\vb{q})^2(E_1-\frac{\vb{(p_1+k)}^2}{2m})}\psi(p_1)\\
  &=-ie^4\bar u_N(P_N)u_N(P_N)\psi^{\dagger}(p_2)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{1}{(\vb{k}-\vb{p_1})^2(\vb{k}-\vb{p_2})^2(E_1-\frac{\vb{k}^2}{2m})}\psi(p_1)
\end{align*}
%\clearpage
The box and crossed box diagram for QED process is\footnote{On-shell condition here on the HQET side is $q^0=0$}
\begin{align*}
  ...
  &=e^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int[\dd k]\frac{(\slashed p_1+\slashed k+m)\g^0}{\vb{k}^2(\vb{k}-\vb{q})^2[(p_1+k)^2-m^2+i\epsilon](-k^0+i\epsilon)}u_e(p_1)\\
  &=e^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int[\dd k]\frac{2p_1^0+\slashed k\g^0}{\vb{k}^2(\vb{k}-\vb{q})^2[(p_1+k)^2-m^2+i\epsilon](-k^0+i\epsilon)}u_e(p_1)\\
  &=ie^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{p_1^0+k_i\g^i\g^0+\sqrt{(\vb{k}+\vb{p_1})^2+m^2}}{2\vb{k}^2(\vb{k}-\vb{q})^2[(\vb{k}+\vb{p_1})^2+m^2-p_1^0\sqrt{(\vb{k}+\vb{p_1})^2+m^2}]}u_e(p_1)\\
  &=ie^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{p_1^0+(k_i-p_{1i})\g^i\g^0+\sqrt{\vb{k}^2+m^2}}{2(\vb{k}-\vb{p_1})^2(\vb{k}-\vb{p_2})^2[\vb{k}^2+m^2-p_1^0\sqrt{\vb{k}^2+m^2}]}u_e(p_1)
 \end{align*}
 ...
 \begin{align*}
  i\mathcal{M}_2^{(1)}&=\begin{tikzpicture}[baseline=($(a)!0.5!(c)$)]
	...
	\end{feynman}
  \end{tikzpicture}\\
  &=e^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int[\dd k]\frac{(\slashed p_1+\slashed k+m)\g^0}{\vb{k}^2(\vb{k}-\vb{q})^2[(p_1+k)^2-m^2+i\epsilon](k^0-q^0+i\epsilon)}u_e(p_1)\\
  &=e^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int[\dd k]\frac{2p_1^0+\slashed k\g^0}{\vb{k}^2(\vb{k}-\vb{q})^2[(p_1+k)^2-m^2+i\epsilon](k^0-q^0+i\epsilon)}u_e(p_1)\\
  &=-ie^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{p_1^0+k_i\g^i\g^0-\sqrt{(\vb{k}+\vb{p_1})^2+m^2}}{2\vb{k}^2(\vb{k}-\vb{q})^2[(\vb{k}+\vb{p_1})^2+m^2+p_1^0\sqrt{(\vb{k}+\vb{p_1})^2+m^2}]}u_e(p_1)\\
  &=-ie^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{p_1^0+(k_i-p_{1i})\g^i\g^0-\sqrt{\vb{k}^2+m^2}}{2(\vb{k}-\vb{p_1})^2(\vb{k}-\vb{p_2})^2[\vb{k}^2+m^2+p_1^0\sqrt{\vb{k}^2+m^2}]}u_e(p_1)
 \end{align*}
...
\begin{align*}
  i\mathcal{M}_1^{(1)}+i\mathcal{M}_2^{(1)}&=ie^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{{p_1^0}^2+\vb{k}^2+m^2+(k_i-p_{1i})p_1^0\g^i\g^0}{(\vb{k}-\vb{p_1})^2(\vb{k}-\vb{p_2})^2[\vb{k}^2+m^2-{p_1^0}^2]\sqrt{\vb{k}^2+m^2}}u_e(p_1)\\
  &=ie^4\bar u_N(P_N)u_N(P_N)u_e^{\dagger}(p_2)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{\vb{p}_1^2+\vb{k}^2+2 m^2+(k_i-p_{1i})p_1^0\g^i\g^0}{(\vb{k}-\vb{p_1})^2(\vb{k}-\vb{p_2})^2[\vb{k}^2-\vb{p_1}^2]\sqrt{\vb{k}^2+m^2}}u_e(p_1)
\end{align*}
Note that after the expansion over external momentum, $k^i$ can be converted into $p^i$ so it's actually at $p^1$ order\footnote{The substituting conditions used here are $\vb{p_2}=\vb{q}+\vb{p_1}$, $\vb{p_1}^2=\vb{p_2}^2$, $\vb{p_1}\cdot\vb{q}=-\frac{1}{2}\vb{q}^2$, $\vb{q}^2=2\vb{p_1}^2-2\vb{p_1\cdot p_2}$.}. From this we can conclude that a contact interaction is presented at $\a^2$ order with coefficient $\frac{4 \pi e^4 }{3 m^2}=\frac{(4\pi)^3\a^2}{3 m^2}$.
...
%\end{align*}
 ...
 \begin{align*}
   \mel{0}{\psi_e(0)N(0)(-ie)\int\dd^4y\bar\psi_e\psi_e A^0(-ie)\int\dd^4z\bar NNA^0}{eN}&=ie^2u_N(v_N)\int[\dd k]\frac{1}{\vb{k}^2(-k^0+i\epsilon)(p_1^0+k^0-m-\frac{\vb{(p_1+k)}^2}{2m}+i\epsilon)}\psi(p_1)\\
   &=e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{1}{\vb{k}^2(E_1-\frac{\vb{(p_1+k)}^2}{2m}+i\epsilon)}\psi(p_1)\\
   &=e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{1}{(\vb{k}-\vb{p_1})^2(E_1-\frac{\vb{k}^2}{2m}+i\epsilon)}\psi(p_1)\\
  \intertext{drop $p_1$}
  &=-e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{2m}{\vb{k}^4}\psi(p_1)
  \end{align*}
...
\begin{align*}
  -\mel{0}{\psi(x)N(0)e^2\int\dd^4y\bar\psi\g^0\psi A^0 \int\dd^4 z \bar N NA^0}{eN}&=ie^2u_N(v_N)\int[\dd k]e^{-i\vb{(k+p_1)}\cdot\vb{x}}\frac{(\slashed p_1+\slashed k+m)\g^0}{\vb{k}^2[(p_1+k)^2-m^2+i\epsilon](-k^0+i\epsilon)}u_e(p_1)\\
  &=ie^2u_N(v_N)\int[\dd k]e^{-i\vb{(k+p_1)}\cdot\vb{x}}\frac{2p_1^0+\slashed k\g^0}{\vb{k}^2[(p_1+k)^2-m^2+i\epsilon](-k^0+i\epsilon)}u_e(p_1)\\
  &=-e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{(k+p_1)}\cdot\vb{x}}\frac{p_1^0+k_i\g^i\g^0+\sqrt{(\vb{k}+\vb{p_1})^2+m^2}}{2\vb{k}^2[(\vb{k}+\vb{p_1})^2+m^2-p_1^0\sqrt{(\vb{k}+\vb{p_1})^2+m^2}]}u_e(p_1)\\
  &=-e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k}\cdot\vb{x}}\frac{p_1^0+(k_i-p_{1i})\g^i\g^0+\sqrt{\vb{k}^2+m^2}}{2(\vb{k}-\vb{p_1})^2[\vb{k}^2+m^2-p_1^0\sqrt{\vb{k}^2+m^2}]}u_e(p_1)\\
  \intertext{drop $\vb{p_1}$}
  &=-e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k}\cdot\vb{x}}\frac{m+\sqrt{\vb{k}^2+m^2}}{2\vb{k}^2[\vb{k}^2+m^2-m\sqrt{\vb{k}^2+m^2}]}u_e(p_1)\\
  &=-e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k}\cdot\vb{x}}\frac{m+\sqrt{\vb{k}^2+m^2}}{2\vb{k}^2\sqrt{\vb{k}^2+m^2}[\sqrt{\vb{k}^2+m^2}-m]}u_e(p_1)\\
  &=-e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k}\cdot\vb{x}}\frac{2m^2+2m\sqrt{\vb{k}^2+m^2}+\vb{k}^2}{2\vb{k}^4\sqrt{\vb{k}^2+m^2}}u_e(p_1)
...
%The easiest part is 
%\begin{align*}
%  \int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k\cdot x}}\frac{m}{\vb{k}^4}&={-m\pi}  x
%\end{align*}
%and also
%\begin{align*}
%  \int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k\cdot x}}\frac{m^2}{\vb{k}^4\sqrt{\vb{k}^2+m^2} }&=\frac{1 }{mx}G_{1,3}^{2,1}\left(\frac{m^2 x^2}{4}|
%\begin{array}{c}
% 2 \\
% \frac{1}{2},\frac{3}{2},0 \\
%\end{array}
...
%\end{align*}
%and 
%By applying contour integral around the branch cut we can transform the third part: 
%\begin{align*}
%  \int\dd^3\vb{k}e^{-i\vb{k\cdot x}}\frac{1}{2\vb{k}^2\sqrt{\vb{k}^2+m^2} }&=-\frac{i}{2x}\int_{-\infty}^{\infty}\dd k\frac{ e^{i k x}}{k  \sqrt{k^2+m^2}}\\
%  \intertext{push the contour}
%  &=-\frac{i}{2x}2\pi i(\int_{+i\infty-\epsilon}^{im}\dd k\frac{ e^{i k x}}{k  \sqrt{k^2+m^2}}+\int_{im}^{+i\infty+\epsilon}\dd k\frac{ e^{i k x}}{k  \sqrt{k^2+m^2}})\\
%  &\stackrel{k\rightarrow-ik}{=\joinrel=\joinrel=\joinrel=}-\frac{-2\pi }{2x}\int_{m}^{\infty}\dd k\frac{ e^{- k x}}{k  \sqrt{k^2-m^2}}\\
%  &=\frac{\pi }{x}\int\dd x K_0(mx)\\
%  &=\frac{\pi^2}{2}(\pmb{L}_{-1}(m x) K_0(m x)+\pmb{L}_0(m x) K_1(m x))
%\end{align*}
...
\begin{align*}
  -\frac{\a}{2}[-mx+\frac{2   G_{1,3}^{2,1}\left(\frac{m^2 x^2}{4}|
\begin{array}{c}
 2 \\
 \frac{1}{2},\frac{3}{2},0 \\
\end{array}
\right)}{\pi m x}+(\pmb{L}_{-1}(m x) K_0(m x)+\pmb{L}_0(m x) K_1(m x))]=\frac{\a}{\pi}(\log \frac{mx}{2}+\g+1)+\mathcal{O}(x)
\end{align*}

If it's scalar QED, the NLO contribution is 
\begin{align*}
  \begin{tikzpicture}[baseline=($(p1)!0.5!(x)$)]
	...
	\diagram* {
	  ...
	  (y1) -- [momentum=\(p_{1}+k\)] (x);
	  (z1) -- [momentum'=\(P_{N}-k\),double distance=1pt] (0);
    };
	\end{feynman}
  \end{tikzpicture}&=ie^2u_N(v_N)\int\frac{\dd^4k}{(2\pi)^4}e^{-i\vb{(k+p_1)\cdot x}}\frac{p_1^0+(p_1^0+k^0)}{\abs{\vb{k}}^2[(p_1+k)^2-m^2+i\epsilon](-k^0+i\epsilon)}\\
  &=-e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{(k+p_1)\cdot x}}\frac{p_1^0+\sqrt{(\vb{k+p_1})^2+m^2}}{2\abs{\vb{k}}^2\sqrt{(\vb{k+p_1})^2+m^2}(\sqrt{(\vb{k+p_1)^2}+m^2}-p^0_1)}\\
  \intertext{shift $\vb{k}$ to $\vb{k-p_1}$}
  &=-e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k\cdot x}}\frac{p_1^0+\sqrt{\vb{k}^2+m^2}}{2\vb{(k-p_1)}^2\sqrt{\vb{k}^2+m^2}(\sqrt{\vb{k^2}+m^2}-p^0_1)}\\
  \intertext{drop $\vb{p_1}$}
  &=-e^2u_N(v_N)\int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k\cdot x}}\frac{m+\sqrt{\vb{k}^2+m^2}}{2\abs{\vb{k}}^2\sqrt{\vb{k}^2+m^2}(\sqrt{\vb{k^2}+m^2}-m)}
\end{align*}
it's exactly the same with NLO QED except for a wavefunction.
...
\begin{align*}
  ...
  &=\int \frac{\dd^3\vb{k}}{(2\pi)^3}\frac{1}{\sqrt{2mv^0}}a_v\sqrt{m}u(v)e^{-imv\cdot x-i\vb{k}\cdot x}\\
  ...
  &=\int \frac{\dd^3\vb{k}}{(2\pi)^3}\frac{1}{\sqrt{2v^0}}a_vu(v)e^{-imv\cdot x-i\vb{k}\cdot x}
\end{align*}
...
\begin{align*}
  Q_v(x)&=e^{imv\cdot x}\frac{1+\slashed v}{2}\psi(x)\\
  &=\int \frac{\dd^3\vb{k}}{(2\pi)^3}\frac{1}{\sqrt{2v^0}}a_v \frac{1+\slashed v}{2}u(v)e^{-i\vb{k}\cdot x}\\
  &=\int \frac{\dd^3\vb{k}}{(2\pi)^3}\frac{1}{\sqrt{2v^0}}a_v u(v)e^{-i\vb{k}\cdot x}
\end{align*}
The commutation relation should be
\begin{align*}
  \{Q_{va}(\vb{x}),Q_{v'b}(\vb{x'})\}&=\int \frac{\dd^3\vb{k}}{(2\pi)^3}\frac{\dd^3\vb{k}'}{(2\pi)^3}\frac{1}{\sqrt{4v^0v'^0}}\{a_v,a_{v'}^{\dagger}\}u_a(v)u_b^{\dagger}(v')e^{-ik\cdot x+ik'\cdot x'}\\
  \intertext{
  using $\sum_s u_a(v)u_b^{\dagger}(v)=\frac{1}{m}\sum_s u_a(p)u^{\dagger}_b(p)=[(\slashed v+1)\g^0]_{ab}$}
  &=\int \frac{\dd^3\vb{k}}{(2\pi)^3}\frac{\dd^3\vb{k}'}{(2\pi)^3}\frac{1}{\sqrt{4v^0v'^0}}\{a_v,a_{v'}^{\dagger}\}[(\slashed v+1)\g^0]_{ab}e^{-ik\cdot x+ik'\cdot x'}\\
  \intertext{assuming $\{a_v,a_{v'}\}=(2\pi)^3\delta_{vv'}\delta^{(3)}(\vb{k-k'})$}
  &=\int \frac{\dd^3\vb{k}}{(2\pi)^3}\frac{1}{2v^0}[(\slashed v+1)\g^0]_{ab}e^{-ik\cdot (x-x')}\delta_{vv'}\\
