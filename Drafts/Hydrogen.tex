...
we can divide this integral into 3 parts. The easiest part is 
\begin{align*}
...
\right)\\
\end{align*}
and by applying contour integral around the branch cut we can do the transformation
\begin{align*}
  \int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k\cdot x}}\frac{1}{2\vb{k}^2\sqrt{\vb{k}^2+m^2} }&=-\frac{i}{2x}\int_{-\infty}^{\infty}\dd k\frac{ e^{i k x}}{k  \sqrt{k^2+m^2}}\\
  ...
  &\stackrel{k\rightarrow-ik}{=\joinrel=\joinrel=\joinrel=}-\frac{-2\pi }{2x}\sqrt{2}e^{i3\pi/4}\int_{m}^{\infty}\dd k\frac{ e^{- k x}}{k  \sqrt{k^2-m^2}}\\
  &=\frac{\pi }{x}\sqrt{2}e^{i3\pi/4}\int\dd x K_0(mx)\\
  &=\frac{\pi^2\sqrt{2}}{2}e^{i3\pi/4}(\pmb{L}_{-1}(m x) K_0(m x)+\pmb{L}_0(m x) K_1(m x))
\end{align*}
If count the NRQED part in, the first part is 
\begin{align*}
  \int\frac{\dd^3\vb{k}}{(2\pi)^3}m\frac{e^{-i\vb{k\cdot x}}-1}{\vb{k}^4}&=-\frac{1}{2}\pi m  x
\end{align*}
the second part is 
\begin{align*}
  \int\frac{\dd^3\vb{k}}{(2\pi)^3}\frac{e^{-i\vb{k\cdot x}}m^2}{\vb{k}^4\sqrt{\vb{k}^2+m^2}}-\frac{m}{\vb{k}^4}=\frac{1}{4}mxG_{1,3}^{2,1}(\frac{m^2x^2}{4}|
  \begin{array}{c}
	1\\
	-\frac{1}{2},\frac{1}{2},-1
  \end{array})
