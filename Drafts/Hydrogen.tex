...
and also
\begin{align*}
  \int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k\cdot x}}\frac{m^2}{\vb{k}^4\sqrt{\vb{k}^2+m^2} }&=\frac{1 }{m^3x}G_{1,3}^{2,1}\left(\frac{m^2 x^2}{4}|
\begin{array}{c}
 2 \\
 \frac{1}{2},\frac{3}{2},0 \\
\end{array}
...
\begin{align*}
  \int\frac{\dd^3\vb{k}}{(2\pi)^3}e^{-i\vb{k\cdot x}}\frac{m^2}{\vb{k}^2\sqrt{\vb{k}^2+m^2} }&=\frac{im^2}{x}\int_{-\infty}^{\infty}\dd k\frac{ e^{-i k x}}{k  \sqrt{k^2+m^2}}\\
  \intertext{push the contour}
  &=\frac{im^2}{x}2\pi i(\int_{+i\infty-\epsilon}^{im}\dd k\frac{ e^{-i k x}}{k  \sqrt{k^2+m^2}}+\int_{im}^{+i\infty+\epsilon}\dd k\frac{ e^{-i k x}}{k  \sqrt{k^2+m^2}})\\
  &\stackrel{k\rightarrow-ik}{=\joinrel=\joinrel=\joinrel=}\frac{-2\pi m^2}{x}\sqrt{2}e^{3\pi/4}\int_{m}^{\infty}\dd k\frac{ e^{- k x}}{k  \sqrt{k^2-m^2}}\\
  &=\frac{-2\pi m^2}{x}\sqrt{2}e^{3\pi/4}\int\dd r K_0(mx)
\end{align*}
