...
\begin{align*}
  \int\dd^3\vb{k}m\frac{e^{-i\vb{k\cdot x}}-1}{\vb{k}^4}&=-\frac{1}{2}\pi m  x
\end{align*}
the second part is 
\begin{align*}
  \int\dd^3\vb{k}(\frac{e^{-i\vb{k\cdot x}}m^2}{\vb{k}^4\sqrt{\vb{k}^2+m^2}}-\frac{m}{\vb{k}^4})=\frac{1}{4}mxG_{1,3}^{2,1}(\frac{m^2x^2}{4}|
  \begin{array}{c}
	1\\
	-\frac{1}{2},\frac{1}{2},-1
  \end{array})
