...
\begin{align*}
  ...
  &\stackrel{k\rightarrow-ik}{=\joinrel=\joinrel=\joinrel=}\frac{-2\pi }{2x}\sqrt{2}e^{3\pi/4}\int_{m}^{\infty}\dd k\frac{ e^{- k x}}{k  \sqrt{k^2-m^2}}\\
  &=\frac{-2\pi }{2x}\sqrt{2}e^{3\pi/4}\int\dd x K_0(mx)
\end{align*}
