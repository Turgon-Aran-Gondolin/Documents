...
\begin{align*}
  -\mel{0}{\psi(x)N(0)e^2\int\dd^4y\bar\psi\g^0\psi A^0 \int\dd^4 z \bar N NA^0}{eN}&=e^2u_N(v_N)\int[\dd k]e^{-i\vb{(k+p_1)}\cdot\vb{x}}\frac{(\slashed p_1+\slashed k+m)\g^0}{\vb{k}^2[(p_1+k)^2-m^2+i\epsilon](-k^0+i\epsilon)}u_e(p_1)\\
...
\begin{align*}
  \begin{tikzpicture}[baseline=($(p1)!0.5!(x)$)]
	...
	\end{feynman}
  \end{tikzpicture}&=-e^2u_N(v_N)\int\frac{\dd^4k}{(2\pi)^4}e^{-i\vb{(k+p_1)\cdot x}}\frac{p_1^0+(p_1^0+k^0)}{\abs{\vb{k}}^2[(p_1+k)^2-m^2+i\epsilon](-k^0+i\epsilon)}\\
  &=ie^2u_N(v_N)\int\frac{\dd^4k}{(2\pi)^4}e^{-i\vb{(k+p_1)\cdot x}}\frac{p_1^0+\sqrt{(\vb{k+p_1})^2+m^2}}{2\abs{\vb{k}}^2\sqrt{(\vb{k+p_1})^2+m^2}(\sqrt{(\vb{k+p_1)^2}+m^2}-p^0_1)}\\
  \intertext{shift $\vb{k}$ to $\vb{k-p_1}$}
  &=ie^2u_N(v_N)\int\frac{\dd^4k}{(2\pi)^4}e^{-i\vb{k\cdot x}}\frac{p_1^0+\sqrt{\vb{k}^2+m^2}}{2\vb{(k-p_1)}^2\sqrt{\vb{k}^2+m^2}(\sqrt{\vb{k^2}+m^2}-p^0_1)}\\
  \intertext{drop $\vb{p_1}$}
  &=ie^2u_N(v_N)\int\frac{\dd^4k}{(2\pi)^4}e^{-i\vb{k\cdot x}}\frac{m+\sqrt{\vb{k}^2+m^2}}{2\abs{\vb{k}}^2\sqrt{\vb{k}^2+m^2}(\sqrt{\vb{k^2}+m^2}-m)}\\
\end{align*}
