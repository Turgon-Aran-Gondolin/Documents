...
\begin{align*}
 ...
 \end{feynman}
 \end{tikzpicture}\\
 =&e^4\int[dk_1][dk_2]\frac{1}{\vb{\abs{k_1}}^2}\frac{1}{\vb{\abs{k_2}}^2}\frac{1}{-k_1^0-k_2^0+i\epsilon}\frac{1}{-k_2^0+i\epsilon}\frac{1}{p_1^0+k_1^0-m-\frac{\vb{(p_1+k_1)}^2}{2m}+i\epsilon}\frac{1}{p_1^0+k_1^0+k_2^0-m-\frac{\vb{(p_1+k_1+k_2)}^2}{2m}+i\epsilon}\psi_e(p_1)u_N(v_N)
\end{align*}
 \section{HSET}
