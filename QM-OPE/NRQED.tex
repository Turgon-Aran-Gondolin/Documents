...
For the bound state, the wavefunction is\cite{Darwin1928,Gordon1928}
\begin{align}
...
\begin{appendices}
	...
	\begin{align*}
		...
		=&-4m^2\mu^{2\epsilon}Z^2e^4
		\int\frac{\dd^3\vb{k_1}}{(2\pi)^3}\frac{\dd^3\vb{k_2}}{(2\pi)^3}\frac{1}{\vb{\abs{k_1-p}}^2}\frac{1}{\vb{\abs{k_2-k_1}}^2}\frac{1}{\vb{\abs{k_1}}^2-2mE}\frac{1}{\vb{\abs{k_2}}^2-2mE}
	\end{align*}
	...
	\begin{flalign*}
		...
		\end{tikzpicture}            &                 \\
		= & -4m^2\mu^{2\epsilon}Z^2e^4
		\int\frac{\dd^3\vb{k_1}}{(2\pi)^3}\frac{\dd^3\vb{k_2}}{(2\pi)^3}\frac{1}{\vb{\abs{k_1-p}}^2}\frac{1}{\vb{\abs{k_2-k_1}}^2}\frac{1}{\vb{\abs{k_1}}^2-2mE}\frac{(\vb{k}_1+\vb{k}_2)^2/8m^2}{\vb{\abs{k_2}}^2-2mE}&\\
