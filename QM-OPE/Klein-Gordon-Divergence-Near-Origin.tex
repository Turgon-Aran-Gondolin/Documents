...
\begin{flalign*}
	\mel{0}{\tilde\varphi(\vb{q})N(0)\tilde\varphi^*(p)\tilde N^*(k)\pqty{\int\dd y (-ie)\varphi^*\varphi A^0}\pqty{\int\dd z (-iZe)N^*NA^0}\pqty{\int\dd t \varphi^*\pqty{-i\frac{{\bm{\nabla}}^4}{8m^3}}\varphi}}{0}
\end{flalign*}
which leads to 
\begin{align*}
	&\begin{tikzpicture}[baseline=($(p1)!0.5!(x)$)]
...
\begin{flalign*}
	&\begin{tikzpicture}[baseline=($(p1)!0.5!(x)$)]
		...
		\end{feynman}
	\end{tikzpicture}        &                                                                      \\
	= & Z^2e^4 \frac{i\bqty{\frac{\vb{q}^4}{8m^3}}}{\bqty{E_p-\frac{\vb{q}^2}{2m}}^2}\int\frac{\dd^4k_1}{(2\pi)^4}\frac{i}{E_p+k_1^0-\frac{\abs{\vb{p+k_1}}^2}{2m}+i\epsilon}\frac{i}{\abs{\vb{p+q+k_1}}^2}\frac{i}{\abs{\vb{k_1}}^2}\frac{i}{-k_1^0+i\epsilon} &\\
	= &  i Z^2e^4(-2m)\frac{i\bqty{\frac{\vb{q}^4}{8m^3}}}{\bqty{E_p-\frac{\vb{q}^2}{2m}}^2}\int\frac{\dd^3\vb{k_1}}{(2\pi)^3}\frac{-2mi}{\abs{\vb{p+k_1}}^2-2mE_p-4mi\epsilon}\frac{1}{\abs{\vb{p+q+k_1}}^2}\frac{1}{\abs{\vb{k_1}}^2}                              &  \\
	= &i Z^2e^4(-2m)\frac{i\bqty{\frac{\vb{q}^4}{8m^3}}}{\bqty{E_p-\frac{\vb{q}^2}{2m}}^2}\int\frac{\dd^3\vb{k_1}}{(2\pi)^3}\frac{1}{\abs{\vb{k_1}}^2-2mE_p-4mi\epsilon}\frac{1}{\abs{\vb{k_1+q}}^2}\frac{1}{\abs{\vb{k_1-p}}^2}&\\ 
	= & i Z^2e^4(-2m)^2\frac{-i\bqty{\vb{q}^4/4m^2}}{\bqty{\abs{\vb{q}}^2-2mE_p-2mi\epsilon}^2}\int\frac{\dd^3\vb{k_1}}{(2\pi)^3}\frac{1}{\abs{\vb{k_1}}^2-2mE_p-4mi\epsilon}\frac{1}{\abs{\vb{k_1+q}}^2}\frac{1}{\abs{\vb{k_1-p}}^2}&
\end{flalign*}
double middle insertion
\begin{align*}
	  & \begin{tikzpicture}[baseline=($(p1)!0.5!(x)$)]
