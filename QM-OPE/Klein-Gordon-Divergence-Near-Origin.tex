...
\begin{align*}
	\mel{0}{\tilde\psi(q)N(0)\tilde\psi(p)\tilde N(k)}{0}=                  %\int\dd^3 \vb{x}e^{i\vb{q}\cdot \vb{x}}\mel{0}{\psi(\vb{x})N(0)\tilde\psi(p)\tilde N(k)}{0}
...
\begin{flalign*}
	   &\mel{0}{\tilde\psi(q)N(0)\pqty{\int e\psi\psi A^0}^2\pqty{\int ZeNNA^0}^2}{e(p)N(k)}=\begin{tikzpicture}[baseline=($(p1)!0.5!(x)$)]
		\begin{feynman}
			\vertex (p1);
			\vertex[right=3cm of p1] (p2);
	...
	= & Z^2e^4(-2mi)\frac{i}{E_q-\frac{\vb{q}^2}{2m}}\int\frac{\dd^3\vb{k_1}}{(2\pi)^3}\frac{1}{\abs{\vb{k_1}}^2-2mE_p-4mi\epsilon}\frac{1}{\abs{\vb{k_1+q}}^2}\frac{1}{\abs{\vb{k_1-p}}^2}&
\end{flalign*}
